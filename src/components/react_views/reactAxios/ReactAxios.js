      ...
      <div className='axios_container'>
        ...
        <div className='axios_section_box'>
          ...
          <div className='axios_section_body'>
            <ul>
              ...
              <li>
                Unlike the Fetch API, which requires you to check the status
                code and throw the error yourself, Axios has better error
                handling and can throw 400 and 500 range errors.
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className='axios_section_box'>
          <div>
            ...
            <div className='axios_section_body'>
              ...
              <p>
                This takes an object to send the data in and also adds the data
                to the state by spreading the previous data and then adding the
                new data:
              </p>
        ...
        <div className='axios_section_box'>
          <div>
            ...
            <div className='axios_section_body'>
              <p>
                To use async/await, first call async in the function. Then add
                the await syntax in front of the function when making a request
                and expecting a response to wait until the promise settles with
                the result.
              </p>
              <p>
        ...
        <div className='axios_section_box'>
          ...
          <div className='axios_section_body'>
            <p>
              ...
              may occur as a result of us passing incorrect data, making a
              request to the incorrect API, or experiencing a network error.
            </p>
            <p>
          ...
          <div>
            ...
            <div className='axios_section_body'>
              <p>
                ...
                .then() method to handle errors. Suppose the .then() method
                fails:
              </p>
        ...
        <div className='axios_section_box'>
          <div>
            ...
            <div className='axios_section_body'>
              <p>
                For the async/await scenario, the try...catch block will look
                like this:
              </p>
