  ...
  return (
    <div className='envPage_main_container'>
      ...
      <div className='envPage_first_section_body'>
        <p>
          Wikipedia says, An environment variable is a dynamic-named value that
          can affect the way running processes will behave on a computer. They
          are part of the environment in which a process runs. For example, a
        ...
        <p>
          ...
          here will anly work if you use create-react-app. create-react-app has
          the support for environment variables by default.
        </p>
      </div>
      ...
      <div className='envPage_third_section'>
        ...
        <div className='envPage_third_section_body'>
          <p>
            If you want to use an environment variable you can import it to any
        ...
        <div className='envPage_fourth_section'>
          ...
          <div className='envPage_fourth_section_body'>
            <p>
              During the development mode, the app works fine without any issues
              but if you want to deploy your app to the public you need to add
